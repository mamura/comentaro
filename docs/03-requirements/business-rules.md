...
### RN-003 — Isolamento da organização
...
### RN-007 — Configuração de notificação
...
### RN-013 — Reconciliação antes de reenviar resposta
...
### RN-014 — Restrição de resposta do iFood
...
- Mecanismo de cadastro, autenticação e recuperação de acesso.
